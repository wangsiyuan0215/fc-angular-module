                            ...
                            function(_, data) {
                                if (data) {
                                    ...
                                    if (__id === data.id) {
                                        ...
                                        !$__body.classList.contains($config.classNames.bodyHidden) &&
                                            $__body.classList.add($config.classNames.bodyHidden);
                                        !$__modal.classList.contains($config.classNames.modalActive) &&
                                            $__modal.classList.add($config.classNames.modalActive);
                                        $timeout(function() {
                                            !$__modalBox.classList.contains($config.classNames.boxActive) &&
                                                $__modalBox.classList.add($config.classNames.boxActive);
                                        }, 200);
                                    }
                                }
                            }
                            ...
                            function(_, data) {
                                if (data) {
                                    ...
                                    if (__id === data.id) {
                                        ...
                                        $timeout(function() {
                                            $__modal.classList.remove($config.classNames.modalActive);
